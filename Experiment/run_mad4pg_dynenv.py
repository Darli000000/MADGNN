...
from Agents.MAD4PG_DynENV.networks import make_default_networks
from Agents.MAD4PG_DynENV.agent_distributed import DistributedD4PG
from Utilities.FileOperator import load_obj


def main(_):
    
    print("Running mad4pg_dynenv!")
    # different scenario
    # scneario 1
    ...
    # /root/Game-Theoretic-Deep-Reinforcement-Learning-main/saved_env/2026-04-22-03-57-56
    ...
    agent = DistributedD4PG(
        ...
        max_actor_steps=300*24000, # EDIT：太长，原本是300*25000
        log_every=5.0,
    )
