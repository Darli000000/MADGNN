...
from Environment.environment import make_environment_spec    # EDIT: 原本使用的是environment_old，现在改回来，有bug再说
from Agents.MAD4PG_GNN.networks import make_default_networks
from Agents.MAD4PG_GNN.agent_distributed import DistributedD4PG
...
def main(_):
    ...
    # EDIT：Darli0 ver2026.3.6
    environment_file_name = "/root/Game-Theoretic-Deep-Reinforcement-Learning-main/saved_env/2026-03-06-10-17-32/convex_environment_df285cc3dcef492bbe1d3cf2520b144b.pkl"
    ...
    agent = DistributedD4PG(
        ...
        networks=networks,
        num_actors=10, # EDIT:10
        environment_spec=spec,
        batch_size=128, # EDIT:256->64
        prefetch_size=4,
        min_replay_size=1000,
        max_replay_size=1000000,
        samples_per_insert=8.0,
        n_step=1,
        sigma=0.2, # EDIT: 0.3 is too big,
        discount=0.996,
        ...
        log_every=5.0,
        gnn_is_dynmic=False # EDIT：控制是否是动态gnn，即是否有prev state
    )
