...
class vehicularNetworkEnvConfig:
    ...
    # 绝对路径：/home/darli0/DeepReinforcementLearningmain/Game-Theoretic-Deep-Reinforcement-Learning-main/Environment/CSV/trajectories_20161116_2200_2205.csv
    # /root/Game-Theoretic-Deep-Reinforcement-Learning-main/Environment/CSV/active_trajectory.csv
    trajectories_file_name: str = '/root/Game-Theoretic-Deep-Reinforcement-Learning-main/Environment/CSV/active_trajectory'
    ...
    """Action related."""
    # DynENV-EDIT: 重新定义vehicle_number_within_edges的语义，改为max_vehicle_slots_per_edge。
    # 即表示，一个edge范围内最多接入的车辆数目
    # vehicle_number_within_edges: Optional[int] = None
    max_vehicle_slots_per_edge: int = 8
